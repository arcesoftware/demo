...
SUBSTEPS = 4              # how many RK4 substeps per appended point (increase for smoother integration)
POINTS_PER_FRAME = 31 # how many points to append each frame (controls drawing speed)
